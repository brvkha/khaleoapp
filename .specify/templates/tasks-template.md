...
**Tests**: Tests are REQUIRED by constitution. Each story MUST include unit tests and integration or contract coverage for changed boundaries.
...
- **Web app (khaleoapp default)**: `backend/src/`, `frontend/src/`
...
- [ ] T004 Configure CI gates for lint + test + build in backend and frontend
...
- [ ] T010 Setup environment configuration and secrets handling
- [ ] T011 Add media/dictionary security controls (signed URL policy, allowlist, timeout/sanitization) when applicable
...
- [ ] T020 US1 Capture performance measurements against declared budgets
...
- [ ] T027 US2 Capture performance measurements against declared budgets
...
- [ ] T033 US3 Capture performance measurements against declared budgets
...
- [ ] TXXX [P] Additional unit tests in tests/unit/ to close coverage gaps
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Verify release gates: green CI, migration status, security findings triage
